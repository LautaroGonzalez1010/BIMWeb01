  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen text-center px-4">
      ...
      <div className="relative z-10">
        <h1 className="text-xl md:text-2xl font-semibold mt-6">Esta página no existe</h1>
        <p className="mt-2 text-base text-gray-400 font-mono">{location.pathname}</p>
        <p className="mt-4 text-lg md:text-xl text-gray-500">Cuéntame más sobre esta página para poder generarla</p>
      </div>
    </div>
  );
}